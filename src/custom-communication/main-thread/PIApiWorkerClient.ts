...
// PIApiWorkerClient - Handles communication with the worker thread
import type {
  IPIApiConfig,
...
import type {
  ...
  IPIApiWorkerResponse,
  PIApiWorkerCommandType,
} from '../shared/WorkerProtocol';

import { PIApiConnectionState, PIApiSessionState } from '../shared/PIApiTypes';
import { PIApiWorkerCommandType as CommandType, PIApiWorkerResponseType } from '../shared/WorkerProtocol';
...
export class PIApiWorkerClient {
